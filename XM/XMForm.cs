    ...
    public partial class XMForm : Form
    {
        ...
        private void XMForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportDataSource dsBB8XMDetails = new ReportDataSource("dsBB8XMDetails", dtBB8Details);
        ...
        private DataTable GetBB8XMReadingsDetails()
        {
            ...
            {
                MessageBox.Show("Oops. Something went wrong while fetching the BB8XMReadings data.");
                LogError _LE = new LogError();
                _LE.LogDetails(ex);
                return null;
            }
        ...
        private DataTable GetBB8XMDetails()
        {
            ...
            {
                MessageBox.Show("Oops. Something went wrong while fetching the BB8XM Details.");
                LogError _LE = new LogError();
                _LE.LogDetails(ex);
                return null;
            }
        ...
        private DataTable GetTempHumidity()
        {
            ...
            {
                MessageBox.Show("Oops. Something went wrong while fetching the BB8XM TempHumidity Details.");
                LogError _LE = new LogError();
                _LE.LogDetails(ex);
                return null;
            }
